...
#if Delete30_Test_Enable
TEST_WITH_TEARDOWN(Delete30, Basic, Delete30_Test_Enable)
{
	pTree = new Tree();
	...
	pTree->SkipThisOne = Tree::SkipDelete::N30;
	...
	CHECK_EQUAL(pN31->pSouth, nullptr);
	CHECK_EQUAL(pN31->pEast, nullptr);
	CHECK_EQUAL(pN31->pWest, nullptr);
