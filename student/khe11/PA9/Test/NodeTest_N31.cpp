...
#if Delete31_Test_Enable
TEST_WITH_TEARDOWN(Delete31, Basic, Delete31_Test_Enable)
{
	pTree = new Tree();
	...
	pTree->SkipThisOne = Tree::SkipDelete::N31;
