...
#if Delete32_Test_Enable
TEST_WITH_TEARDOWN(Delete32, Basic, Delete32_Test_Enable)
{
	pTree = new Tree();
	...
	pTree->SkipThisOne = Tree::SkipDelete::N32;
	...
	CHECK_EQUAL(pN33->pSouth, nullptr);
	CHECK_EQUAL(pN33->pEast, nullptr);
	CHECK_EQUAL(pN33->pWest, pN31);

} TEST_END

TEST_TEARDOWN(Delete32, Basic)
{
	delete pTree;
}
#endif
