...
#if Delete22_Test_Enable
TEST_WITH_TEARDOWN(Delete22, Basic, Delete22_Test_Enable)
{
	pTree = new Tree();
	...
	pTree->SkipThisOne = Tree::SkipDelete::N22;
