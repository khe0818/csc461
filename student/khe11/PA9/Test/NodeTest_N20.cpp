...
#if Delete20_Test_Enable
TEST_WITH_TEARDOWN(Delete20, Basic, Delete20_Test_Enable)
{
	pTree = new Tree();
	...
	pTree->SkipThisOne = Tree::SkipDelete::N20;
