...
#if Delete21_Test_Enable
TEST_WITH_TEARDOWN(Delete21, Basic, Delete21_Test_Enable)
{
	pTree = new Tree();
	...
	pTree->SkipThisOne = Tree::SkipDelete::N21;
