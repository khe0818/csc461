...
#if Delete23_Test_Enable
TEST_WITH_TEARDOWN(Delete23, Basic, Delete23_Test_Enable)
{
	pTree = new Tree();
	...
	pTree->SkipThisOne = Tree::SkipDelete::N23;
	...
	CHECK_EQUAL(pN22->pNorth, nullptr);
	CHECK_EQUAL(pN22->pSouth, nullptr);
	CHECK_EQUAL(pN22->pEast, nullptr);
	CHECK_EQUAL(pN22->pWest, nullptr);
