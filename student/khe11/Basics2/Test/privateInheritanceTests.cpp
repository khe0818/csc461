...
#if Private1_Test_Enable    
TEST(Private1, PrivateInheritanceTests, Private1_Test_Enable)
{
...
//  to make sure you get an error for each of the following statements
// #define WRAPPER_CHECK

#ifdef WRAPPER_CHECK // change this to make sure you get an error for each of the following statements
