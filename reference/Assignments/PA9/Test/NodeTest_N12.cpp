...
#if Delete12_Test_Enable
TEST_WITH_TEARDOWN(Delete12, Basic, Delete12_Test_Enable)
{
	pTree = new Tree();
	...
	pTree->SkipThisOne = Tree::SkipDelete::N12;
