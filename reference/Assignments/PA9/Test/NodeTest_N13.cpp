...
#if Delete13_Test_Enable
TEST_WITH_TEARDOWN(Delete13, Basic, Delete13_Test_Enable)
{
	pTree = new Tree();
	...
	pTree->SkipThisOne = Tree::SkipDelete::N13;
