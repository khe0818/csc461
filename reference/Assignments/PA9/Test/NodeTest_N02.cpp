...
#if Delete02_Test_Enable
TEST_WITH_TEARDOWN(Delete02, Basic, Delete02_Test_Enable)
{
	pTree = new Tree();
	...
	pTree->SkipThisOne = Tree::SkipDelete::N02;
	...
	CHECK_EQUAL(pN12->pNorth, nullptr);
	CHECK_EQUAL(pN12->pSouth, pN22);
	CHECK_EQUAL(pN12->pEast, nullptr);
	CHECK_EQUAL(pN12->pWest, pN11);
