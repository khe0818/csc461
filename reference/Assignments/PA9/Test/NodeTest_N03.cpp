...
#if Delete03_Test_Enable
TEST_WITH_TEARDOWN(Delete03, Basic, Delete03_Test_Enable)
{
	pTree = new Tree();
	...
	pTree->SkipThisOne = Tree::SkipDelete::N03;
	...
	CHECK_EQUAL(pN02->pNorth, nullptr);
	CHECK_EQUAL(pN02->pSouth, nullptr);
	CHECK_EQUAL(pN02->pEast, nullptr);
	CHECK_EQUAL(pN02->pWest, nullptr);
